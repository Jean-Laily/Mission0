    ...
    */
    ...
    public static void creerCommune(String param1, String param2, String param3) {//Correspondant au Create de CRUD
      ...
      try {
        ...
        if(codePostControler == true){
          afficher("Erreur: le code postal existe! ");
        }else{
          String sqlAdd = "INSERT INTO communes (codePostal, nomCommune, nbHabitants) VALUES ('"+param1+"', '"+param2+"', '"+param3+"')";
          Statement statment = cn.createStatement();
          statment.executeUpdate(sqlAdd);
